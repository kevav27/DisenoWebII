...
const { renderIndex, renderBitacorasConsultas, renderBitacorasRegistro, renderBodega,renderCamiones, renderClientes, renderClientesConsultas, renderConfirmarOrden,renderConsecutivos, renderCrearOrden, renderEventos, renderInventario, renderMateriaPrima, renderParametros, renderPedidosPendientesConsultas, renderProduccionLote, renderProductos, renderProveedores,renderPuntoVenta, renderRoles,renderTiposMateriaPrima, renderUsuarios,} = require('../controllers/index.controller')
